...
//  printf("\n\nvariable r adalah int\nvariable e adalah float\n");
    ...
    // penggunaan % akan menampilkan sisa dari suatu pembagian ( modulus )
    // z = x%y;
    // printf("\n%d", z);

    // selanjutnya adalah increment ++, langkahnya juga sama ketika menggunakan --.
    // x++;
    // printf("\n%d",x);

    // berikutnya adalah augmented assigment operator
    // yaitu mengubah langsung nilai variable nya seperti contoh berikut 
